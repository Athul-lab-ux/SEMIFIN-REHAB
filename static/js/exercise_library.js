...
const EXERCISES = [
  /* ============ 1 · HEMIPARESIS (active weakness / ROM loss) ============ */
  {
    ...
    steps: [
      S("Bend your elbow (flex)", (m) => m.elbowMax != null && m.elbowMax <= 80),
      S("Extend arm toward the target", (m) => m.elbowMax != null && m.elbowMax >= 115, 1),
      S("Return to the bent position", (m) => m.elbowMax != null && m.elbowMax <= 85),
    ],
  },
  {
    ...
    steps: [
      S("Rest your arm by your side", (m) => m.elbowMax != null && m.elbowMax <= 95),
      S("Push your hand far forward", (m) => m.elbowMax != null && m.elbowMax >= 145 && m.reach > 0.14, 1),
      S("Return your hand back", (m) => m.elbowMax != null && m.elbowMax <= 100),
    ],
  },
  {
    ...
    steps: [
      S("Arm resting down", (m) => m.elevMax != null && m.elevMax < 25),
      S("Raise your arm up high", (m) => m.elevMax != null && m.elevMax >= 60, 1),
      S("Lower your arm slowly", (m) => m.elevMax != null && m.elevMax < 25),
    ],
  },
  {
    ...
    steps: [
      S("Arm at your side", (m) => m.elevMax != null && m.elevMax < 25),
      S("Sweep your arm outward", (m) => m.elevMax != null && m.elevMax >= 50, 0.8),
      S("Return arm to your side", (m) => m.elevMax != null && m.elevMax < 25),
    ],
  },
  {
    ...
    steps: [
      S("Both elbows bent", (m) => m.elbowMax != null && m.elbowMax <= 100),
      S("Push both hands forward together", (m) => m.elbowMin != null && m.elbowMin >= 130, 1),
  ...
  /* ============ 2 · FLEXOR SPASTICITY (involuntary tightness) ============ */
  {
    ...
    steps: [
      S("Make a loose fist", (m) => m.spread != null && m.spread < 0.07),
      S("Open your palm wide", (m) => m.spread != null && m.spread > 0.11, 1.5),
  ...
  },
  {
    ...
    steps: [
      S("Elbow bent (flexed)", (m) => m.elbowMax != null && m.elbowMax <= 95),
      S("Slowly extend past the gate", (m) => m.elbowMax != null && m.elbowMax >= 115 && (m.speed == null || m.speed < 0.9), 1),
      S("Return slowly", (m) => m.elbowMax != null && m.elbowMax <= 95),
    ],
  },
  {
    ...
    steps: [
      S("Slowly clench a fist", (m) => m.spread != null && m.spread < 0.05, 0.8),
      S("Open your hand wide", (m) => m.spread != null && m.spread > 0.10, 0.8),
    ],
  },
  {
    ...
    steps: [
      S("Fingers together", (m) => m.fan != null && m.fan < 0.09),
      S("Fan your fingers wide apart", (m) => m.fan != null && m.fan > 0.15, 1.2),
  ...
  },
  {
    ...
    steps: [
      ...
      S("Extend wrist backward", (m) => m.dev != null && m.dev > 14, 1.2),
  ...
  /* ============ 6 · WRIST DROP (extensor paresis) ============ */
  {
    ...
    steps: [
      S("Neutral wrist", (m) => m.dev != null && Math.abs(m.dev) < 8),
      S("Cock wrist upward (+15°)", (m) => m.dev != null && m.dev > 15, 1.2),
      S("Return to neutral", (m) => m.dev != null && Math.abs(m.dev) < 8),
    ],
  },
  {
    ...
    steps: [
      S("Sweep wrist outward (radial)", (m) => m.dev != null && m.dev > 12),
      S("Sweep wrist inward (ulnar)", (m) => m.dev != null && m.dev < -10),
      S("Sweep outward again", (m) => m.dev != null && m.dev > 12),
    ],
  },
  {
    ...
    steps: [
      S("Wrist relaxed down", (m) => m.dev != null && m.dev < 5),
      S("Slowly extend up & hold", (m) => m.dev != null && m.dev > 12 && (m.speed == null || m.speed < 0.8), 1.2),
      S("Relax back down", (m) => m.dev != null && m.dev < 5),
    ],
  },
  {
    ...
    steps: [
      S("Hand resting", (m) => m.dev != null && m.dev < 6),
      S("Point & keep wrist lifted", (m) => m.dev != null && m.dev > 10 && m.spread != null && m.spread > 0.06, 2),
      S("Rest your hand", (m) => m.dev != null && m.dev < 6),
    ],
  },
  {
    ...
    steps: [
      ...
      S("Open palm + lift wrist", (m) => m.spread != null && m.spread > 0.10 && m.dev != null && m.dev > 10, 1),
